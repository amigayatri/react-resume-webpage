...
import { paletteKey } from "../../../../types/palette/index.ts"
...
export const ByGroup = ({
    ...
    const [group, setGroup] = useState(defaultValue === undefined ? "rainbow" : defaultValue.group)
    const [palette, setPalette] = useState(defaultValue === undefined ? "rainbow monokai" : defaultValue.palette)
        ...
        <>
            ...
            <Select
                ...
                onSelectChange={(event) => {
                    ...
                    if (newPaletteName !== "_" && !isPaletteName(newPaletteName.split("_")[1])) return
                    onSelect(event)
                    setPalette(newPaletteName as paletteKey)
                }}

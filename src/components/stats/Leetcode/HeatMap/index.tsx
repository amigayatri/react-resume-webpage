...
import { Color, variationSteps, changeSteps } from "../../../../lib/colors"
...
const prevSteps = variationSteps
const currSteps = 13
changeSteps(currSteps)
...
let max = -1
changeSteps(prevSteps)

export const HeatMap = ({ leetcode, t, lng }: LeetCodeProps) => {

const showURL =
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vSWl4nUiwg4npv2nxQzIFQETZLTG6BcE4JURIl1Menscbc7pu1_6_r9p2AN7fSKMhE8LWmdk_J2Dj3T/pub?gid=0&single=true&output=csv"
//Temos hospedagem?,Transporte volta,Início,Fim,Hospedagem
...
const formatAndParseDate = (dateStr: string) => new Date(new String(dateStr).split("/").reverse().join("-").concat("GMT -3"))
